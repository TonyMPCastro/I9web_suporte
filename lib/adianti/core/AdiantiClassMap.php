...
class AdiantiClassMap
{
    public static function getMap()
    {
        ...
        $classPath['TStrippedTextMinLengthValidator'] = 'lib/adianti/validator/TStrippedTextMinLengthValidator.php';
        $classPath['TStrippedTextMaxLengthValidator'] = 'lib/adianti/validator/TStrippedTextMaxLengthValidator.php';
        ...
        $classPath['BuilderApplication']              = 'lib/mad/core/BuilderApplication.php';
        $classPath['BDateRange']                      = 'lib/mad/widget/form/BDateRange.php';
