...
class AtendenteForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $system_user_id->addValidation("Nome", new TRequiredValidator()); 
        ...
        $row2 = $this->form->addFields([new TLabel("Usuário:", '#FF0000', '14px', null, '100%'),$system_user_id]);
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['AtendenteList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('AtendenteList', 'onShow', $loadPageParam); 
