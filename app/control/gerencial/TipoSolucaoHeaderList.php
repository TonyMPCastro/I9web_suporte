...
class TipoSolucaoHeaderList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('TipoSolucaoForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TipoSolucaoHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de tipo soluções");
        ...
        $button_cadastrar->setAction(new TAction(['TipoSolucaoForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['TipoSolucaoHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['TipoSolucaoHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['TipoSolucaoHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['TipoSolucaoHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Gerencial","Tipo soluções"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TipoSolucao($key, FALSE); 
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for TipoSolucao
