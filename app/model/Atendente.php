...
class Atendente extends TRecord
{
    ...
    public function get_chamado_solicitante_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('solicitante_id','{solicitante->id}');
    ...
    public function get_chamado_status_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('status_id','{status->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_prioridade_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('prioridade_id','{prioridade->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_produto_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('produto_id','{produto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_categoria_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('categoria_id','{categoria->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_atendente_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('atendente_id','{atendente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_tipo_problema_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('tipo_problema_id','{tipo_problema->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_tipo_solucao_to_string()
    {
        ...
        $values = Chamado::where('atendente_id', '=', $this->id)->getIndexedArray('tipo_solucao_id','{tipo_solucao->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_nota_chamado_to_string()
    {
        ...
        $values = Nota::where('atendente_id', '=', $this->id)->getIndexedArray('chamado_id','{chamado->id}');
        return implode(', ', $values);
    }
    ...
    public function get_nota_cliente_to_string()
    {
        ...
        $values = Nota::where('atendente_id', '=', $this->id)->getIndexedArray('cliente_id','{cliente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_nota_atendente_to_string()
    {
        ...
        $values = Nota::where('atendente_id', '=', $this->id)->getIndexedArray('atendente_id','{atendente->id}');
        return implode(', ', $values);
    }
