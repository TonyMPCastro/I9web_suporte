...
class TipoSolucao extends TRecord
{
    const TABLENAME  = 'tipo_solucao';
    const PRIMARYKEY = 'id';
    ...
    public function getChamados()
    {
        ...
        $criteria->add(new TFilter('tipo_solucao_id', '=', $this->id));
    ...
    public function get_chamado_solicitante_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('solicitante_id','{solicitante->id}');
    ...
    public function get_chamado_status_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('status_id','{status->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_prioridade_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('prioridade_id','{prioridade->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_produto_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('produto_id','{produto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_categoria_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('categoria_id','{categoria->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_atendente_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('atendente_id','{atendente->id}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_tipo_problema_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('tipo_problema_id','{tipo_problema->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_chamado_tipo_solucao_to_string()
    {
        ...
        $values = Chamado::where('tipo_solucao_id', '=', $this->id)->getIndexedArray('tipo_solucao_id','{tipo_solucao->nome}');
        return implode(', ', $values);
    }
